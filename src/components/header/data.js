...
export const FeatureList = [
  {
    ...
    text: "For web development, I'm a huge fan of React.js and node js, react and it's ecosystem (e.g. Next.js & Gatsby.js). I also use bootstrap and good in craco, mdb-ui-kit, react-bootstrap etc",
  },
  {
    id: 2,
