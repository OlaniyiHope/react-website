...
export const FeatureList = [
  {
    id: 1,
    icon: <FaAccessibleIcon className="text-color bold" size={22} />,
  ...
  {
    id: 2,
    icon: <SiDatabricks className="text-color bold" size={22} />,
    heading: "Keep Your History",
    text: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repudiandae veniam dolorum repellendus obcaecati minus voluptas neque dolore similique.",
  },
  {
    id: 3,
    icon: <MdConnectWithoutContact className="text-color bold"  size={22} />,
    heading: "Stay Connected",
    text: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repudiandae veniam dolorum repellendus obcaecati minus voluptas neque dolore similique.",
  },
  {
    id: 4,
    icon: <FaGg className="text-color bold"  size={22} />,
