...
function Projects() {
  return (
    ...
    <Container fluid className="project-section">
      ...
      <Container>
        <h1 className="project-heading text-color bold" style={{textAlign: "center"}}>
          <strong className="purple text-color bold">Some of my Works </strong>
        </h1>
        <p className="text-color bold " style={{textAlign: "center", fontSize: 16}}>
